...
if (!empty($uhid)) {
  ...
  $strvisit  = "  INSERT INTO tmse(uhid,tmse1_1,tmse1_1_detail,tmse1_2,tmse1_2_detail,
  tmse1_3,tmse1_3_detail,tmse1_4,tmse1_4_detail,tmse1_5,tmse1_5_detail,tmse1_6,tmse1_6_detail,
  ...
  hn,cid,assessor_date,assessor,total,result,dateadd) 
      ...
      '" . $tmse3_1 . "','" . $tmse3_2 . "','" . $tmse3_3 . "','" . $tmse3_4 . "','" . $tmse3_5 . "',
      '" . $tmse4_1 . "','" . $tmse4_2 . "','" . $tmse4_3 . "',
