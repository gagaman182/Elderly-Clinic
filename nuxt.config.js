...
export default {
    ...
    head: {
        titleTemplate: '%s - คลินิกผู้สูงอายุ  รพ.หาดใหญ่',
    ...
    plugins: [
        { src: '@/plugins/vueexcel', mode: 'client' }
    ],
    ...
    fontawesome: {
        component: 'fa',
        icons: { // ex      <fa :icon="['fas', 'hospital']" size="2x" color="red" />
            solid: true,
            brands: true
        }
    },
    ...
    axios: {
        ...
        // baseURL: '/',
        baseURL: 'http://localhost/Elderly-Clinic/backend/',
    },
